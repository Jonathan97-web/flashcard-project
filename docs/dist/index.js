...
const form = document.getElementById("new-flashcard-form") || null;
const input = document.querySelector("#new-flashcard-title");
const inputDescription = document.querySelector("#new-flashcard-description");
const inputAnswer = document.querySelector("#new-flashcard-answer");
...
form?.addEventListener("submit", (e) => {
  ...
  if (input?.value == "") {
    ...
    swal("Cannot add empty flashcard!", "Please add an answer to your flashcard!", "error");
  } else {
    const newFlashcard = {
      id: uuidV4(),
      title: input?.value || "",
...
function addListItem(flashcard) {
  ...
  editButton.addEventListener("click", (e) => {
    ...
    saveButton.addEventListener("click", (e2) => {
